...
def visualise_country_wise(freq_country_total_df,freq_country_df,sort_val,col_name):
    """
    This function will visualise frequency of mental health country wise
    freq_country_total_df:dataset with the count of total patient with mental health issue
    freq_country_df:dataset with the count of patient with mental health issue who sought for treatment
    col_name: a user-defined column
    sort_val: a user-defined sorting value
    """
...
def visualise_state_wise(freq_state_total_df,freq_state_df,sort_val,col_name):
    ...
    """
    This function will visualise frequency of mental health state wise
    freq_state_total_df:dataset with the count of total patient with mental health issue
    freq_state_df:dataset with the count of patient with mental health issue who sought for treatment
    col_name: a user-defined column
    sort_val: a user-defined sorting value
    """
    #Plotting total patients country wise
...
def visualise_attitude_awareness(Total_df,Yes_df,sort_val,col_name):
    ...
    """
    This function will visualise attitude/awareness of mental health state wise
    Total_df:dataset with the count of patient with mental health issue who had answers other than yes to the question
    Yes_df:dataset with the count of patient with mental health issue who had yes as the answer to the question
    col_name: a user-defined column
    sort_val: a user-defined sorting value
    """
    #Plotting total patients country wise
    fig, ax=plt.subplots(figsize=(10,5))
    ax.bar(x=Total_df.Country,height=Total_df[col_name])
    ...
    #Plotting patients that sought for treatment country wise
    fig1, ax1=plt.subplots(figsize=(10,5))
    ax1.bar(x=Yes_df.Country,height=Yes_df[col_name])
